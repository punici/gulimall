...
import com.punici.gulimall.product.dao.SkuSaleAttrValueDao;
        ...
        implements SkuSaleAttrValueService
{
    ...
    {
        IPage<SkuSaleAttrValueEntity> page = this.page(new Query<SkuSaleAttrValueEntity>().getPage(params), new QueryWrapper<>());
